...
Mobile.tap(findTestObject('android.widget.TextView3 - Login (6)'), 0)

Mobile.setText(findTestObject('android.widget.EditText0 - Email (7)'), 'fajar2@mailinator.com', 0)

Mobile.setText(findTestObject('android.widget.EditText1 (6)'), 'fajar1234', 0)
...
Mobile.tap(findTestObject('android.widget.ImageView5 (8)'), 0)

Mobile.tap(findTestObject('android.widget.TextView2 - Contact'), 0)

Mobile.tap(findTestObject('android.widget.ImageView4 (2)'), 0)

Mobile.tap(findTestObject('android.widget.ImageView15'), 0)

Mobile.tap(findTestObject('android.widget.ImageView14 (1)'), 0)
